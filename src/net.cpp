...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Elektron " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strMainNetOnionSeed[][1] = {
    {"id3cdlr2ezexromw.onion"},
	{"6nqvgabjwq4nffm5.onion"},
	{"lum5vmk2fcivojw3.onion"},
	{"g22qt5vjf2elntmy.onion"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Elektron is probably already running."), addrBind.ToString().c_str());
        else
