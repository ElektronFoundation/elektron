...
private slots:
    ...
    void on_BuyEKN_clicked();
    void on_SellEKNBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputEKN_textChanged(const QString &arg1);
    ...
    QString BuyEKN(QString OrderType, double Quantity, double Rate);
    QString SellEKN(QString OrderType, double Quantity, double Rate);
